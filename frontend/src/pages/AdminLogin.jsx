...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('');
      alert('Admin login successful! Welcome to CloudNest Admin Panel.');
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <Link to="/" className="inline-flex items-center space-x-3 mb-8">
            ...
            <span className="text-2xl font-bold text-gray-900">CloudNest Admin</span>
          </Link>
          ...
          <p className="text-lg text-gray-600 max-w-sm mx-auto">
            Access the admin panel for CloudNest
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500 flex items-center justify-center space-x-1">
            ...
            <span>Secure admin access for CloudNest management</span>
          </p>
        </div>
      </div>
    </div>
